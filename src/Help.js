...
function Help({ navigateTo }) {
  ...
  const faqItems = [
    {
      id: 'faq1',
      question: 'Как работает обмен?',
      answer: 'Вы выбираете сумму, подтверждаете заявку и отправляете средства. После подтверждения обмен будет завершён.',
    },
    {
      id: 'faq2',
      question: 'Сколько времени занимает обмен?',
      answer: 'Обычно обмен занимает от 5 до 30 минут в зависимости от сети.',
    },
    {
      id: 'faq3',
      question: 'Какие комиссии?',
      answer: 'Все комиссии уже включены в итоговую сумму.',
    },
    {
      id: 'faq4',
      question: 'Что делать если перевод завис?',
      answer: 'Свяжитесь с поддержкой через профиль или подождите подтверждений сети.',
    },
  ];
  ...
  const rulesContent = [
    {
      id: 'rule1',
      title: 'Общие правила',
      content: 'Запрещено использовать сервис для незаконной деятельности.',
    },
    {
      id: 'rule2',
      title: 'Ответственность',
      content: 'Пользователь несёт ответственность за корректность введённых данных.',
    },
  ];
  ...
  return (
    <div className="tg-help-page">
      ...
      {/* CONTENT */}
      <div className="tg-help-content">

        {activeSection === 'faq' && (
          <div className="tg-faq-list">
            {filteredFaqItems.map(item => (
              <div key={item.id} className="tg-faq-item">
                <button
                  className="tg-faq-question"
