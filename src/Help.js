...
function Help({ navigateTo }) {
    ...
    const faqItems = [
        ...
        },
        {
            id: 'rules-3',
            category: 'rules',
            question: "Верификация аккаунта",
            answer: "Требуется для:\n1. Сумм свыше 50,000 RUB\n2. Вывода реферальных средств\n3. Повышения лимитов\n4. Подтверждения личности\nВерификация занимает до 24 часов"
        },
        {
            id: 'security-1',
            category: 'security',
            question: "Меры безопасности",
            answer: "1. Используйте двухфакторную аутентификацию\n2. Не передавайте данные аккаунта третьим лицам\n3. Проверяйте адреса кошельков\n4. Сохраняйте квитанции об оплате\n5. Связывайтесь только через официальный чат поддержки"
        },
        {
            id: 'security-2',
            category: 'security',
