    ...
    const faqItems = [
        {
            ...
            answer: "Выберите направление обмена, введите сумму, выберите способ оплаты и нажмите кнопку 'Купить' или 'Продать'. В открывшемся диалоговом окне следуйте инструкциям оператора для завершения операции."
        },
        {
            id: 'faq-1',
        ...
        },
        {
            ...
            answer: "Минимальная сумма: 10 USDT или 1000 RUB. Максимальная сумма : 10 000 USDT или 1 000 000 RUB."
        },
        {
            id: 'faq-3',
        ...
        },
        {
            ...
            answer: "Приглашайте друзей в наш обманник ! Получайте 0.5% от суммы реферала обменявшего валюту. "
        }
    ];
